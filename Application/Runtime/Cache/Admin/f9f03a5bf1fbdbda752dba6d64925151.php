        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="/index.php/Admin/User/modify/user_id/<?php echo ($vol["user_id"]); ?>" class="tablelink">修改</a> <a href="/index.php/Admin/User/del/user_id/<?php echo ($vol["user_id"]); ?>" class="tablelink"> 删除</a></td>
