        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><img src="<?php echo (ltrim($vol["goods_small_logo"],'.')); ?>"/></td>
                    <td><?php echo ($vol["goods_price"]); ?></td>
                    <td><?php echo ($vol["goods_number"]); ?></td>
                    <td><?php echo (date('Y-m-d H:i:s',$vol["add_time"])); ?></td>
                    <td><?php if($vol["is_del"] == 0): ?>显示<?php else: ?>隐藏<?php endif; ?></td>
                    <td><a href="/index.php/Admin/Goods/photos/goods_id/<?php echo ($vol["goods_id"]); ?>" class="tablelink">相册</a> <a href="#" class="tablelink"> 删除</a></td>
